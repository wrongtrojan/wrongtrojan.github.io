...
```C++
  ...
  string add(string a;string b){
    ...
    while(i<a.size()||i<b.size()||carry>0){
      ...
      res.push_back((sum%10)+'0');carry=sum/10;
    }
...
```C++
  ...
  string substract(string a,string b;){
    ...
    while(digit<a.size()){
      int digitA=a[i]-'0';
      int digitB=(digitSize<b.size())?(b[i]-'0'):0;
      digitA-=borrow;
      borrow=0;
      if(digitA<digitB){
        digitA+=10;
...
```C++
  ...
  string multiply(string a,string b){
    ...
    reverse(a.begin(),a.end());
    reverse(b.begin(),b.end());
    vector<int> resArr(lenA+lenB,0);
    for(int i=0;i<lenA;i++){
      int digitA=a[i]-'0';
      for(int j=0;j<lenB;j++){
        int digitB=b[j]-'0';
        resArr[i+j]+=digitA*digitB;
      }
    }
